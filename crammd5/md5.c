...
static uint32_t _ie = 0x44332211;
static union _endian { uint32_t i; unsigned char b[4]; } *_endian = (union _endian *)&_ie;
 ...
 */
static void 
_byte_reverse (unsigned char *buf, uint32_t longs)
{
	uint32_t t;
	do {
